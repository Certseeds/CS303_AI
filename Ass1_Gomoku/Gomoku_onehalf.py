...
def get_arrays(chessboard,point):
    ...
    for i in range(15):
        columnn2 = []
        for j in range(15):
            columnn2.append(chessboard[j][i])
        Align.append(np.asarray(chessboard[i]))
        Align.append(np.asarray(columnn2))
    for i in range(15):
        x1 = 14 - i
        y1 = 14
        x2 = 0
        ...
        for j in range(0,i+1,1):
            secn2.append(chessboard[x1+j][y1-j])
            secn3.append(chessboard[x2+i][y2-i])
        Align.append(np.asarray(secn2))
        Align.append(np.asarray(secn3))
    for i in range(15):
        x1 = 0+i
        y1 = 14
        x2 = 14
        ...
        cscn3 = []
        for j in range(0,i+1,1):
            cscn2.append(chessboard[x1-j][y1-j])
            cscn3.append(chessboard[x2-i][y2-i])
        Align.append(np.asarray(cscn2))
        Align.append(np.asarray(cscn3))
    return Align
