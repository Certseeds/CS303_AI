...
class AI(object):
    ...
    def go(self, chessboard):
        ...
        for i in range(0, len(idx)):
            ...
            #print(i)
            numbers[i] = self.get_max_value(chessboard, 0, idx[i])
    ...
    def get_max_value(self,chessboard,depth,point):
        # print(point)
        # print(depth)
        chessboard[point[0]][point[1]] = self.color
        score = self.judgement_grade(chessboard, point)
        if depth <= 0:
        ...
        for i in range(len(idx)):
            #print(i)
            scores = self.get_min_value(chessboard,depth,idx[i])
            if max_value < scores:
                max_value = scores
                willreturn.clear()
                willreturn.append(max_value)
        chessboard[point[0]][point[1]] = 0
        return score + willreturn[len(willreturn) -1]

    def get_min_value(self,chessboard,depth,point):
        # print(point)
        # print(depth)
        ...
        for i in range(len(idx)):
            #print(i)
            scores = self.get_max_value(chessboard, depth, idx[i])
            if  min_value  > scores:
                min_value = scores
                willreturn.clear()
                willreturn.append(min_value)
        chessboard[point[0]][point[1]] = 0
        return score + willreturn[len(willreturn) -1]
